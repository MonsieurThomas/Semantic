      ...
      <div className="bg-gray-100 p-8 rounded-xl flex my-6 items-center justify-center gap-10 z-10">
        <div className="flex-1 text-center">
          ...
          <p className="text-justify" style={{ fontSize: "16px" }}>
            Le mind mapping simplifie la visualisation des idées complexes en
            les structurant sous forme d&apos;arbre, à partir de mots-clés.
          </p>
          <p className="text-justify" style={{ fontSize: "16px" }}>
            Ce faisant, la mind map permet de regrouper des éléments sous forme
            thématique en facilitant la navigation à travers une large quantité
            d&apos;informations.
          </p>
          <p className="text-justify" style={{ fontSize: "16px" }}>
            Idéal pour professionnels gérant de nombreux documents, il
            transforme la recherche en une expérience claire et rapide.
          </p>
        </div>
        <div className="flex-1">
          <Image
            src={mindMappingImage}
  ...
  },
  {
    ...
    content: (
      <div className="bg-gray-100 px-8 py-8 rounded-xl flex my-6 items-center justify-center gap-10 z-10">
        ...
        <div className="flex-1 text-center">
          <h2 className="text-2xl font-semibold mb-12">
            Le mind mapping à la sauce Semantic
          </h2>
          <p className="text-justify " style={{ fontSize: "16px" }}>
            Notre intuition a été d&apos;utiliser les mind maps non pas comme
            outil d&apos;apprentissage mais comme un outil de navigation pour
            naviguer clairement dans une grande quantité d&apos;informations.
          </p>
          <p className="text-justify" style={{ fontSize: "16px" }}>
            Sur Semantic, suivre une branche de la map, c&apos;est trouver le
            chemin le plus rapide vers les parties de vos documents qui vous
            intéressent vraiment.
          </p>
          <p className="text-justify" style={{ fontSize: "16px" }}>
            Aucun scroll, aucun Ctrl+Tab pour changer de document, laissez vous
            guider par les mots-clés et trouvez directement toute
